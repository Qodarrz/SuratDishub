		...
		<div class="flex flex-col gap-4">
			<div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
				<div>
					...
					<p class="text-sm text-gray-500">Kelola data surat masuk, surat keluar, dan standar teknis dengan
						mudah.</p>
				</div>
			</div>
		</div>
	...
	<div class="py-6">
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
			<div class="relative overflow-hidden rounded-3xl bg-indigo-600 text-white shadow-lg">
				...
				<div
					class="relative px-8 py-8 sm:px-10 sm:py-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
					<div>
						<p class="text-sm font-medium mb-2">Admin Panel Surat</p>
						<h1 class="text-2xl sm:text-3xl font-bold mb-2">Selamat Datang, Admin!</h1>
						<p class="text-sm sm:text-base text-indigo-100 max-w-xl">Pantau statistik surat masuk, surat
							keluar, dan standar teknis setiap bulan maupun setiap tahun secara cepat dan efisien.</p>
					</div>
						...
						<div class="h-16 w-16 sm:h-20 sm:w-20 rounded-2xl bg-white/10 flex items-center justify-center">
							<svg class="h-10 w-10 text-white" xmlns="http://www.w3.org/2000/svg" fill="none"
								...
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
									d="M4 19h16M4 15l4-6 4 4 4-7 4 9" />
							</svg>
						</div>
					</div>
				</div>
			...
			<div class="flex items-center justify-end mt-4">
				<form action="{{ route('pencarian.index') }}" method="GET" class="flex items-center gap-2"
					...
					<input type="text" name="q" id="searchInput" placeholder="Cari nomor surat..."
						...
						value="{{ request('q') }}">
					<button type="submit"
						class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-600 text-white text-sm font-medium shadow hover:bg-cyan-700 transition-colors">
			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
						...
						<div class="h-10 w-10 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center">
							<svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
								...
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.7"
									d="M4 6.75h16.5M4 12h10.5M4 17.25h7" />
							</svg>
						</div>
					</div>
						...
						<div
							...
							<svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
								...
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.7"
									d="M4.5 18.25h15" />
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.7"
									d="M7 15V8.75a1.25 1.25 0 011.25-1.25H11m3 0h2.75A1.25 1.25 0 0118 8.75V15" />
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.7"
									d="M11 15V6.75A1.25 1.25 0 0112.25 5.5H13" />
							</svg>
						</div>
					</div>
					<div class="flex items-end justify-between">
				...
				<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col gap-4">
					<div class="flex items-center justify-between">
						...
						<div
							class="h-10 w-10 rounded-xl bg-fuchsia-50 text-fuchsia-600 flex items-center justify-center">
							<svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
								stroke="currentColor">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.7"
									d="M6 7.25h12M6 11.5h6.5M6 15.75h9" />
			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
				<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col gap-4">
					<div class="flex items-start justify-between">
						...
						<div
							class="h-10 w-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center flex-shrink-0">
							<svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
								stroke="currentColor">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.7"
									d="M12 6v6l3 3" />
					...
					<div class="mt-1 flex justify-start">
						<a href="{{ route('surat-masuk.index') }}"
							...
							<svg class="ml-1 h-3 w-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
								stroke="currentColor">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
									d="M9 5l7 7-7 7" />
							</svg>
					...
					<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
						<div class="flex items-center justify-between mb-4">
							<div>
								...
								<p class="text-xs text-gray-500">Perbandingan jumlah surat masuk dan surat keluar tahun
									{{ $chartYear ?? now()->year }}. Grafik ini bersifat informatif dan tidak dapat
									diklik.
								</p>
							</div>
						</div>
