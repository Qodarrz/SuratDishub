...
<body
        ...
        @if (Route::has('login'))
            <nav class="flex items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-4">
                    <img src="{{ asset('images/dishub-logos.png') }}" alt="Logo Dinas Perhubungan"
                        class="h-12 w-auto object-contain" />
                    <div class="flex flex-col">
                        <span class="text-lg font-bold text-[#1b1b18] dark:text-[#EDEDEC]">DINAS PERHUBUNGAN</span>
                        <span class="text-sm font-medium text-[#06b6d4]">KOTA BOGOR</span>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            class="inline-block px-4 py-1.5 rounded-md text-sm font-medium text-white bg-[#06b6d4] hover:bg-[#0596b8] transition-colors duration-150">
                        ...
                        <a href="{{ route('register') }}"
                            class="inline-block px-4 py-1.5 rounded-md text-sm font-medium text-[#06b6d4] border border-[#06b6d4] hover:bg-[#06b6d4] hover:text-white transition-colors duration-150">
                            Register
                        </a>
                        @endif --}}
                    @endauth
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-[1100px] lg:flex-row items-stretch">
            <div
                class="text-base leading-normal flex-1 p-6 pb-12 lg:p-16 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none flex flex-col justify-center">
                <div class="max-w-md lg:max-w-xl space-y-5">
                    <h1 class="font-semibold text-3xl lg:text-4xl leading-snug tracking-tight"
                        style="text-wrap: balance;">SISTEM INFORMASI PENGELOLAAN SURAT</h1>
                    <h2 class="font-medium text-lg lg:text-xl leading-snug tracking-tight text-[#06b6d4] mt-2"
                        style="text-wrap: balance;">DINAS PERHUBUNGAN KOTA BOGOR</h2>
                    <p class="text-[#706f6c] dark:text-[#A1A09A] text-base lg:text-lg leading-relaxed">Sistem ini
                        membantu Anda mengelola surat masuk dan surat keluar dengan lebih mudah dan efisien.</p>

                    <div class="pt-2">
                        <a href="{{ route('dashboard') }}"
                            class="inline-block px-6 py-3 rounded-md text-white text-sm font-medium leading-normal bg-[#06b6d4] hover:bg-[#0596b8] border border-transparent dark:bg-[#036b8c] dark:hover:bg-[#025f72] shadow-sm transition-colors duration-200">
                            Login ke Sistem
                        </a>
                    </div>
                </div>
            ...
            <div
                ...
                <div class="w-full py-8 lg:py-12 flex items-center justify-center bg-white dark:bg-black">
                    <img src="{{ asset('images/hero.jpg') }}" alt="Management illustration"
    ...
    <!-- Footer -->
    <footer class="w-full lg:max-w-4xl max-w-[335px] text-xs text-[#706f6c] dark:text-[#A1A09A] mt-8 pb-4">
        <div class="text-center space-y-1">
            <p>© 2026 Savare'4 Solution</p>
            <p>Sistem dikembangkan untuk kebutuhan internal instansi.</p>
        </div>
    </footer>
</body>
